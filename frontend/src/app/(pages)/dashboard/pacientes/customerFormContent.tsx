      ...
      <div className="flex flex-col items-center space-y-4">
        <div className="relative">
          {customer && customer.photoUrl ? (
            ...
            <div className="w-37.5 h-37.5 rounded-full bg-muted flex items-center justify-center">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input
            id="fullName"
            name="fullName"
            placeholder="João da Silva Castro"
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <Textarea
            id="address"
            name="address"
            placeholder="Rua das Rosas, Rodovia Marechal, Número 150, Belém..."
